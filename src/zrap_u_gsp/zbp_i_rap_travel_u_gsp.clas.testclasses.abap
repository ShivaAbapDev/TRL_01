*"* use this source file for your ABAP unit test classes
 ...
 CLASS ltcl_integration_test IMPLEMENTATION.
   ...
   METHOD create_travel.
     ...
     DATA travels_in TYPE TABLE FOR CREATE zi_rap_travel_U_GSP\\travel.
     ...
     MODIFY ENTITIES OF zi_rap_travel_u_GSP
       ENTITY travel
     ...
     SELECT * FROM zi_rap_travel_u_GSP WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .
   ...
   METHOD class_setup.
     cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
         i_for_entities = VALUE #( ( i_for_entity = 'ZI_RAP_TRAVEL_GSP' )
                                 ( i_for_entity = 'ZI_RAP_BOOKING_GSP' ) )
                               ).
   ENDMETHOD.
