CLASS lhc_ZI_RAP_BOOKING_U_GSP DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
...
CLASS lhc_ZI_RAP_BOOKING_U_GSP IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx      = CORRESPONDING zsrap_booking_u_gsp( <entity> MAPPING FROM ENTITY ).
