CLASS zcl_ce_rap_agency_gsp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zsc_rap_agency_gsp=>tys_z_travel_agency_es_5_type-agency_id.
    TYPES t_business_data TYPE TABLE OF zsc_rap_agency_gsp=>tys_z_travel_agency_es_5_type.
...
CLASS zcl_ce_rap_agency_gsp IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_GSP' ).
